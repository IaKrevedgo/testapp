...
print(S)
print('Эточ что за %s %s %d %s поебень?!!!'%('змееподобная' ,'ебучая',int('33'),'и важная')) #заменяет символы %s и %d в строке на строки и символы в скобках количество % и аргументов должно совпадать
